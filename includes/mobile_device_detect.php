...
/*
  ...
  Due to my capitalist nature and liking for expensive items I am only prepared to offer support to those who have paid the $20 upgrade fee ;)

  To submit a support request please forward your PayPal receipt with your questions to the email address you sent the money to and I will endeavour to get back to you.

  The function has five parameters that can be passed to it which define the way it handles different scenarios. These paramaters are:
  ...
  switch(true){ // using a switch against the following statements which could return true is more efficient than the previous method of using if statements
    ...
    break; // break out and skip the rest if we've had a match on the iphone or ipod
     ...
     case (eregi('ipad',$user_agent)); // we find the words iphone or ipod in the user agent
        header('Location: '.$mobileredirect); // redirect to the right url for this device
    	exit;
    	break; // break out and skip the rest if we've had a match on the iphone or ipod
